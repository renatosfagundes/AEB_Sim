"""
AEB with Overlay Dashboard
===========================
Launches Gazebo + AEB + integrated dashboard overlay showing
chase camera feed with dashboard gauges at the bottom.

Usage:
  ros2 launch aeb_gazebo aeb_overlay.launch.py scenario:=ccrs_40
"""
...
def generate_launch_description():
    ...
    overlay = Node(
        package='aeb_gazebo',
        executable='dashboard_overlay.py',
